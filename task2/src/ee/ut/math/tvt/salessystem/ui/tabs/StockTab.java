...
public class StockTab implements SalesSystemTab {
	...
	public void addStockItemEventHandler() {
		...
		JOptionPane op = new JOptionPane(new Object[] { "Name:", itemName, "Price:", itemPrice,
		    "Quantity: ", itemQuantity }, JOptionPane.QUESTION_MESSAGE, JOptionPane.OK_CANCEL_OPTION,
		    null, null);
